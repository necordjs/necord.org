...
reported by contacting the project team at contact@socketsomeone.me. Todas as reclamações serão revisadas e investigadas e resultarão em uma resposta considerada necessária e apropriada às circunstâncias. A equipe do projeto é obrigada a manter a confidencialidade sobre o relator do incidente.
