...
<p style={{ display: 'flex', justifyContent: 'center', gap: '1.5rem' }}>
	<a href="https://necord.org">Documentação✨</a>
	<a href="https://github.com/necordjs/necord">Código fonte 🪡</a>
	<a href="https://github.com/necordjs/samples">Exemplos 🛠️</a>
	<a href="https://discord.gg/mcBYvMTnwP">Comunidade 💬</a>
</p>
</div>
