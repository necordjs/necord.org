...
export class AppService {
    @On('messageCreate')
    public onMessageCreate(@Context() [message]: ContextOf<'messageCreate'>): void {
...
export type ContextOfCustomUserUpdate<K extends keyof CustomUserUpdateEvents> =
	CustomUserUpdateEvents[K];
...
export class UserUpdateHandler extends BaseHandler<CustomUserUpdateEvents> {
	...
	public handleUserAvatarUpdate([oldUser, newUser]: ContextOf<'userUpdate'>): void {
...
export class AppService {
	...
	public onAvatarUpdate(@Context() context: ContextOfCustomUserUpdate<'userAvatarUpdate'>): void {
